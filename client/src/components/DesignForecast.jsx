  ...
  const slides = [
    {
      ...
      videoUrl: "../assets/design-forecast-2026.mp4",
      trendingTopics: [
    ...
    },
    {
      ...
      videoUrl: "../assets/city-magnetic.mp4",
      trendingTopics: [
        "A New Vision for Co-Living Conversions",
        "Gensler Product Sustainability Standards™",
        "Conversions+™ by Gensler"
    ...
    },
    {
      ...
      videoUrl: "../assets/airport-terminal.mp4",
      trendingTopics: [
        "A New Vision for Co-Living Conversions",
        "Gensler Product Sustainability Standards™",
        "Conversions+™ by Gensler"
    ...
    },
    {
      ...
      learnMoreText: "LEARN MORE",
      imageUrl: "../assets/hospital-future.jpg", 
      trendingTopics: [
        "A New Vision for Co-Living Conversions",
        "Gensler Product Sustainability Standards™",
        "Conversions+™ by Gensler"
    ...
    },
    {
      ...
      learnMoreText: "LEARN MORE",
      videoUrl: "../assets/workplace-design.mp4",
      trendingTopics: [
        "A New Vision for Co-Living Conversions",
        "Gensler Product Sustainability Standards™",
        "Conversions+™ by Gensler"
    ...
    },
    {
      ...
      learnMoreText: "LEARN MORE",
      videoUrl: "../assets/innovative-company.mp4",
      trendingTopics: [
        "A New Vision for Co-Living Conversions",
        "Gensler Product Sustainability Standards™",
        "Conversions+™ by Gensler"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className={`absolute inset-0 bg-gradient-to-r ${currentMedia.backgroundColor}`} />
